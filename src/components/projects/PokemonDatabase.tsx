      ...
      <div className="max-w-4xl mx-auto p-8">
        ...
        <div className="bg-slate-900 rounded-2xl p-8 shadow-xl">
          <div className="mb-8 flex justify-center">
            <img 
              src={BASE_URL + "/pokeball.png"} 
              alt="Pokemon Database"
              className="w-64 h-64 object-contain rounded-xl"
            />
          </div>
          
          <h1 className="text-4xl font-bold text-slate-200 mb-4">Pokemon API Database</h1>
          <p className="text-lg text-gray-400 mb-8">
            Browse and explore 1000+ Pokémon with stats, abilities & evolutions powered by PokeAPI
          </p>
          
          <div className="border-t border-slate-800 pt-8">
            <h2 className="text-2xl font-semibold text-slate-300 mb-4">About This Project</h2>
            <p className="text-gray-400 mb-4">
              A comprehensive Pokemon database application that allows users to browse, search, 
              and explore detailed information about all Pokemon from the franchise.
            </p>
            
            <h3 className="text-xl font-semibold text-slate-300 mb-3 mt-6">Features</h3>
            <ul className="list-disc list-inside text-gray-400 space-y-2">
              <li>Browse 1000+ Pokemon with detailed stats</li>
              <li>View abilities, types, and evolution chains</li>
              <li>Search and filter Pokemon by various criteria</li>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <span className="px-3 py-1 bg-slate-800 rounded-full text-sm text-cyan-400">PokeAPI</span>
